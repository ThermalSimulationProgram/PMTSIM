function [Tpeak, Timp] = calculatePeakTempLowerBound(isFast, TM, tslp, tact, Timp)
...
if ~isFast
    ...
    [Timp, TM] = completeTimp(TM, tslp, tact, Timp, isAct, isPeriodic, scalor);

end


%% calculate the temperature
Temperature = computeTempLowerBound(TM, tslp, tact, Timp, isAct, isPeriodic);
